...
def init_session_state():
    ...
    if "alertes_territoire" not in st.session_state:
        st.session_state.alertes_territoire = {
            "Isabelle COLIN": {"alertes": [
                ...
                {"type":"🏘️ Social — précarité / pauvreté","ville":"Viry-Châtillon","urgence":"Modéré",
                 "description":"Augmentation des demandes au CCAS : +32% en 6 mois.","actions":"Partenariat Croix-Rouge initié","nb_personnes":950,"date":"10/04/2026 09:15"},
            ]},
    ...
    if "alertes_traitees" not in st.session_state:
        ...
        st.session_state.alertes_traitees = {
            ...
            "Isabelle COLIN___3": {"statut":"Traitée","commentaire":"Partenariat CCAS validé.","opportunite":"","opportunite_type":"","date_traitement":"18/04/2026 10:12"},
            ...
            "Nasser BENKHEMIS___1": {"statut":"Non traitée","commentaire":"","opportunite":"","opportunite_type":"","date_traitement":""},
        }
...
def page_inbox_directeur(df: pd.DataFrame):
    ...
    for col, val, lbl, color in [
        (c1, nb_total,     "Total alertes",    "#1A56DB"),
        (c2, nb_critiques, "🔴 Critiques",     "#DC2626"),
        (c3, nb_non_trait, "⏳ Non traitées",  "#D97706"),
        (c4, nb_opport,    "💡 Opportunités",  "#059669"),
    ]:
        with col:
            st.markdown(
                f'<div class="iceberg-card" style="text-align:center;">'
                f'<div style="font-size:32px;font-weight:800;color:{color};">{val}</div>'
                f'<div style="font-size:11px;color:#64748B;font-weight:600;margin-top:4px;">{lbl}</div>'
                f'</div>', unsafe_allow_html=True)
    ...
    with fc2:
        filtre_statut = st.selectbox("Filtrer par statut", ["Tous","Non traitée","En cours","Traitée","Escaladée"])
    with fc3:
