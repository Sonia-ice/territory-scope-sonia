            ...
            if type_s == "Emploi":
                ...
                contacts = [
                    {"ini":"FT","nom":"France Travail","poste":f"Agence {dept_n}",
                     "clr":"#1A56DB","tags":["Emploi","Reconversion"],
                    ...
                    {"ini":"BP","nom":"Bpifrance","poste":"Direction régionale Île-de-France",
                     "clr":"#059669","tags":["Financement","PME"],
                     "note":"Prêts, garanties et accompagnement TPE/PME",
                     "url":"https://www.bpifrance.fr","tel":"0969 370 240"},
                    {"ini":"CI","nom":"CCI Paris Île-de-France","poste":"Réseau entreprises",
                     "clr":"#D97706","tags":["Réseau","Conseil"],
                     "note":"Accompagnement création/reprise d'entreprise",
                     "url":"https://www.cci-paris-idf.fr","tel":"01 55 65 44 44"},
                ]
            elif type_s == "Médical":
                ...
                contacts = [
                    {"ini":"AR","nom":"ARS Île-de-France","poste":"Agence Régionale de Santé",
                     "clr":"#DC2626","tags":["Zonage","Subventions MSP"],
                     "note":"Valide dossiers MSP, aides à l'installation médecins",
                     "url":"https://www.iledefrance.ars.sante.fr","tel":"01 44 02 00 00"},
                    {"ini":"CP","nom":"CPAM Essonne / Val-de-Marne","poste":"Assurance Maladie",
                     "clr":"#D97706","tags":["DSP","Financement"],
                     "note":"Contrats d'amélioration de l'accès aux soins (CAQES)",
                     "url":"https://www.ameli.fr","tel":"36 46"},
                    {"ini":"OR","nom":"CDOM 91 / 94","poste":"Conseil Dép. de l'Ordre des Médecins",
                     "clr":"#6D28D9","tags":["Annuaire médecins","Installation"],
                     "note":"Mise en relation avec médecins en attente d'installation",
                     "url":"https://www.conseil-national.medecin.fr","tel":"01 53 89 32 00"},
                ]
            else:
                ...
                # Lien dynamique annuaire service-public pour la mairie
                commune_slug = ville_n.lower().replace(" ", "-").replace("'", "-")
                contacts = [
                    {"ini":"MA","nom":f"Mairie de {ville_n}","poste":"Service Urbanisme / PLU",
                     "clr":"#1A56DB","tags":["PLU","Permis","Foncier"],
                     "note":"Consulter le PLU et les zones à enjeux fonciers",
                     "url":f"https://lannuaire.service-public.fr/navigation/commune?text={commune_slug}","tel":"—"},
                    {"ini":"GP","nom":"Choose Paris Region","poste":"Invest in Greater Paris",
                     "clr":"#059669","tags":["Investissement","Implantation"],
                     "note":"Accompagnement gratuit implantation entreprises en IdF",
                     "url":"https://www.chooseparisregion.org","tel":"01 42 67 97 00"},
                    {"ini":"BP","nom":"Bpifrance","poste":"Financement projets innovants",
                     "clr":"#6D28D9","tags":["Prêts","Garanties"],
                     "note":"Prêts croissance, fonds propres pour projets > 1M€",
                     "url":"https://www.bpifrance.fr","tel":"0969 370 240"},
                ]
