    ...
    for al in filtered:
        ...
        with st.expander(
            ...
            if not rows_ville.empty:
                ...
                rev = safe_val(rv.get("revenu_median",0))
                ...
                <div style="background:#EBF1FF;border:1px solid #BFDBFE;border-radius:12px;padding:12px 16px;margin-bottom:10px;">
                  ...
                  <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:8px;">
                    ...
                    <div style="text-align:center;"><div style="font-size:16px;font-weight:800;color:#0A0F1E;">{rev} €</div><div style="font-size:9px;color:#64748B;">Rev. médian</div></div>
