    ...
    if mode_carte == "Heatmap IA":
        ...
        for _, row in top20.iterrows():
            ...
            folium.Marker(
                ...
                icon=folium.DivIcon(html=icon_html, icon_size=(80, 30), icon_anchor=(7, 7)),
...
def page_attractivite(df: pd.DataFrame):
    ...
    with sc1:
        # Forcer la valeur initiale à 2025 si pas encore de session
        if "slider_annee_carte" not in st.session_state:
            st.session_state["slider_annee_carte"] = 2025
        annee_sel = st.slider(
            "", min_value=2025, max_value=2030, step=1,
