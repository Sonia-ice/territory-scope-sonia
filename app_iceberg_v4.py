...
def _build_popup_html(row: pd.Series) -> str:
    """Génère le HTML du popup riche : jauges ML + secteurs recommandés ou freins."""
    ...
    return (
        f"<div style='font-family:Plus Jakarta Sans,sans-serif;min-width:250px;max-width:280px;padding:2px;'>"
        # ── En-tête dégradé ───────────────────────────────────────
